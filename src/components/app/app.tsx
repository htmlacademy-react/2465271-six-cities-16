...
import { DEFAULT_CITY, CITIES, SortList, RATING, AppRoute, AuthorizationStatus, Sign, Locations} from '../../const';
...
function App ({cities, sortType, sign, offers, incomingOffer, offerComments, rating}: AppProps): JSX.Element {
  ...
  const [activeCity, setActiveCity] = useState<keyof typeof Locations>(DEFAULT_CITY);
